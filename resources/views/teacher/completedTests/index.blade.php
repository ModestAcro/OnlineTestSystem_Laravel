    ...
    <div class="container card shadow p-4">
        ...
        <div class="table-responsive mt-4 d-none d-sm-block">
            <table class="table">
                ...
                <tr>
                    <td>{{ $loop->iteration + $completedTests->firstItem() - 1 }}</td>
                    ...
                    <td>
                        <a href="{{route('completed-tests.show', $test->id)}}" class="btn btn-outline-danger">
        ...
        <!-- Wersja dla małych ekranów (Karty) -->
            ...
            @foreach($completedTests as $test)
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <strong>Rok:</strong> {{$test->created_at->format('Y-m-d')}}<br>
                            <strong>Grupa:</strong> {{$test->group->name}}<br>
        ...
        <div class="d-flex justify-content-center mt-4 ">
            {{ $completedTests->links('pagination::bootstrap-4') }}
        </div>

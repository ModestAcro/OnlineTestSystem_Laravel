    ...
    <div class="container card shadow p-4">
        <form action="{{route('courses.store')}}" method="post">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="fs-2 fs-md-3 fs-lg-5 pt-2">Utwórz kierunek</h1>
            </div>

            <h1 class="mt-5">Nazwa</h1>
            <input class="form-control mb-3" rows="4" name="name" placeholder="Wpisz nazwę kierunku" value="{{old('name')}}">
            ...
            <button type="submit" class="btn btn-outline-danger mb-5">Utwórz</button>
        </form>
        @error('name')

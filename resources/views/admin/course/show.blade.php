    ...
    <div class="container card shadow p-4">
        <div>
            <div class="d-flex justify-content-between align-items-center mb-5">
                <h1 class="fs-2 fs-md-3 fs-lg-5 pt-2">Informacja kierunku</h1>
                <a class="btn btn-outline-danger" href="{{route('courses.edit', $course->id)}}">
                    <span class="d-none d-sm-inline">Edytuj kierunek</span>
                </a>
            </div>

            <div class="d-flex align-items-center">
                <p><strong>Nazwa:</strong> {{$course->name}}</p>
            </div>
            ...
            <div class="d-flex align-items-center">
                <p>
                    ...
                    @else
                        <p><strong>Uwagi: </strong> {{ $course->comments }}</p>
                    @endif
            </div>
        </div>
    </div>

    ...
    <main class="main my-5">
        <div class="container card shadow p-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-outline-danger" href="{{route('students.create')}}">
                    <i class="bi bi-plus-circle"></i>
                    <span class="d-none d-sm-inline">Dodaj studenta</span>
                </a>
            </div>
            <p>Ilość: {{$studentsCount}}</p>
                ...
                <table class="table">
                    ...
                    @foreach($students as $student)
                        <tr>
                            ...
                            <td>{{$student->email}}</td>
                            <td>
                                <a href="{{ route('students.show', $student->id) }}" class="btn btn-outline-danger">

...
<main class="main my-5">
    <div class="container card shadow p-4">
        <form action="{{route('subjects.update', $subject->id)}}" method="post">
            ...
            <input class="form-control mb-3" rows="4" name="name" placeholder="Wpisz nazwę kierunku" value="{{$subject->name}}">

            <h1>Uwagi</h1>
            <textarea class="form-control mb-3" rows="4" name="comments" placeholder="Wpisz uwagi" >{{ $subject->comments }}</textarea>

            <button type="submit" class="btn btn-outline-danger">Zapisz zmiany</button>

    ...
    <div class="container card shadow p-4">
        <div>
            <div class="d-flex justify-content-between align-items-center mb-5">
                <h1 class="fs-2 fs-md-3 fs-lg-5 pt-2">Informacja przedmiotu</h1>
                <a class="btn btn-outline-danger" href="{{route('subjects.edit', $subject->id)}}">
                    <span class="d-none d-sm-inline">Edytuj przedmiot</span>
                </a>
            </div>
            ...
            <div class="d-flex align-items-center">
                <p>
                    ...
                    @else
                        <p><strong>Uwagi:</strong> {{$subject->comments }}</p>
                    @endif
                </p>
            </div>
        </div>

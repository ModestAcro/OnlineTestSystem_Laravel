    ...
    <div class="container card shadow p-4">
        <form action="{{route('subjects.store')}}" method="post">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="fs-2 fs-md-3 fs-lg-5 pt-2">Utwórz przedmiot</h1>
            </div>

            <h1 class="mt-5">Nazwa</h1>
            <input class="form-control mb-3" rows="4" name="name" placeholder="Wpisz nazwę przedmiotu">

            <h1>Uwagi</h1>
            <textarea class="form-control mb-3" rows="4" name="comments" placeholder="Wpisz uwagi" ></textarea>

            <button type="submit" class="btn btn-outline-danger">Utwórz</button>
        </form>
        @error('name')

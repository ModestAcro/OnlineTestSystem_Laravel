    ...
    <div class="container card shadow p-4">
        <form action="{{route('teachers.store')}}" method="post">
            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
                <h1 class="fs-2 fs-md-3 fs-lg-5 pt-2">Dodaj wykładowcę</h1>
            </div>


            <div class="mb-3">
                <h1 class="mt-2">Kierunki</h1>
            ...
            <input class="form-control mb-3" rows="4" name="degree" placeholder="Wpisz stopień wykładowcy"  value="{{old('degree')}}">

            <h1 class="mt-2">Imię</h1>
            <input class="form-control mb-3" rows="4" name="name" placeholder="Wpisz imię wykładowcy" value="{{old('name')}}">

            <h1 class="mt-2">Nazwisko</h1>
            <input class="form-control mb-3" rows="4" name="surname" placeholder="Wpisz nazwisko wykładowcy" value="{{old('surname')}}">

            <h1 class="mt-2">Email</h1>
            <input type="email" class="form-control mb-3" rows="4" name="email" placeholder="Wpisz email wykładowcy" value="{{old('email')}}">

            <h1 class="mt-2">Hasło</h1>
            <input type="password" class="form-control mb-3" rows="4" name="password" placeholder="Wpisz hasło wykładowcy">

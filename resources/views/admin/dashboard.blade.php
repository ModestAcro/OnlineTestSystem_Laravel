    ...
    <div class="container py-4">
        <div class="row g-3">
            ...
            <div class="col-md-6 col-lg-3">
                <a href="{{route('teachers.index')}}" class="text-decoration-none text-dark">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <img src="{{asset('images/icons/teacher-avatar.svg')}}" alt="Teacher Icon" class="img-fluid mb-2" style="width: 50px;">
            ...
            <div class="col-md-6 col-lg-3">
                <a href="{{ route('students.index') }}" class="text-decoration-none text-dark">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <img src="{{asset('images/icons/student-avatar.svg')}}" alt="Student Icon" class="img-fluid mb-2" style="width: 50px;">
            ...
            <div class="col-md-6 col-lg-3">
                <a href="{{route('subjects.index')}}" class="text-decoration-none text-dark">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <img src="{{asset('images/icons/book.svg')}}" alt="Subject Icon" class="img-fluid mb-2" style="width: 50px;">
            ...
            <div class="col-md-6 col-lg-3">
                <a href="{{route('courses.index')}}" class="text-decoration-none text-dark">
                    <div class="card text-center shadow-sm">
                        <div class="card-body">
                            <img src="{{asset('images/icons/map-signs.svg')}}" alt="Course Icon" class="img-fluid mb-2" style="width: 50px;">
